...
namespace SmartBuild
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                cfg.UseSqlServer(Configuration.GetConnectionString("SmartBuildConnectionString"));
                //services.AddDbContextPool<Context>(options => options.UseSqlServer(connection));
                //cfg.ConfigureWarnings(x => x.Ignore(RelationalEventId.AmbientTransactionWarning));
            });
